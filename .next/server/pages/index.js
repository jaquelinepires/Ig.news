...
"use strict";
module.exports = JSON.parse('{"name":"ignews","version":"0.1.0","private":true,"scripts":{"dev":"next dev","build":"next build","start":"next start","lint":"next lint"},"dependencies":{"@prismicio/client":"^5.1.0","@stripe/stripe-js":"^1.21.1","axios":"^0.24.0","faunadb":"^4.4.1","next":"11.1.2","next-auth":"3.13.2","prismic-dom":"^2.2.6","react":"17.0.2","react-dom":"17.0.2","react-icons":"^4.2.0","sass":"^1.41.0","stripe":"^8.176.0"},"devDependencies":{"@types/next-auth":"^3.15.0","@types/node":"^16.9.1","@types/prismic-dom":"^2.1.1","@types/react":"^17.0.21","eslint":"7.32.0","eslint-config-next":"11.1.2","typescript":"^4.4.3"}}');
